...
std::string openBaseString = "smart_car";
...
smart_car::KinematicsForward service;

ros::Time timeCurrent;
ros::Time timePrevious;

void onEncoderMessage(const smart_car::Velocity::ConstPtr& input){
...
int main(int argc, char **argv){
    ...
    kinematicsForwardWorld  = node.serviceClient<smart_car::KinematicsForward>("kinematics_forward_world" );
    kinematicsForwardMobile = node.serviceClient<smart_car::KinematicsForward>("kinematics_forward_mobile");
